...
import { gameDisplay } from "./wpGame.module.css"
      ...
      <div style={{ backgroundColor: "lightgrey", height: "130vh" }}>
        <div style={{ position: "absolute", paddingLeft: 30 }}>
          <div style={{ border: "solid", borderColor: "black", padding: 10 }}>
            <h3 style={{ textAlign: "center", borderBottom: "solid" }}>
              {" "}
              Extra details
            </h3>
            <ul style={{ listStyle: "none" }}>
              <li>
                <text style={{ fontWeight: "bold" }}>Age rating:</text>
                {game.ageRating}
              </li>
              <li>
                <text style={{ fontWeight: "bold" }}>Development cost:</text>
                {game.developmentCost}
              </li>
              <li>
                <text style={{ fontWeight: "bold" }}>development team:</text>
                {game.developmentTeam}
              </li>
              <li>
                <text style={{ fontWeight: "bold" }}>Metacritic score:</text>
        ...
        <div style={{display: "flex",alignItems: "center",flexDirection: "column"}}>
          ...
          <h2>{game.title}</h2>
          <GatsbyImage image={image} alt={game.picture.altText} style={{ maxHeight: 300, maxWidth: 300,marginBottom:50 }}/>
